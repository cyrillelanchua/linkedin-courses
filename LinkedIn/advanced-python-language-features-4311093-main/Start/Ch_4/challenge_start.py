...
books = [
    ...
    Book(
        "Moby Dick", "Herman Melville", 427, BookCover.PAPERBACK, True, 22.95
    ),
    Book(
        "A Christmas Carol",
        "Charles Dickens",
    ...
    Book(
        "Animal Farm", "George Orwell", 130, BookCover.PAPERBACK, False, 26.95
    ),
    Book("Farenheit 451", "Ray Bradbury", 256, BookCover.HARD, True, 28.95),
    Book(
        "Jane Eyre", "Charlotte Bronte", 536, BookCover.PAPERBACK, False, 34.95
    ),
]
